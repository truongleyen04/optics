...
\maketitle
\input{jihe/feima}
\input{jihe/chengxiang}
\input{jihe/guangxueyiqi}

\input{bodong/ganshe}
\input{bodong/jiezhi}
\input{bodong/ganshe_shikong}
\input{bodong/duoyuan.tex}
\input{bodong/foulier}
\input{bodong/quanxi.tex}
\input{bodong/jingti.tex}
